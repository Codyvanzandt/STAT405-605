...
Controversy score is defined as $\frac{pn}{|p-n|}$, where $p$ is the number of 5-star reviews and $n$ is the number of 1-star reviews
...
-   Do popular books explode onto the scene or accumulate readers more gradually?
    -   From the killer plot, we can see that books tend to explode onto the scene. After their initial popularity decline though, subsequent popularity surges accumulate readers gradually.
-   How do the popular success and critical acclaim of novels differ?
    -   Critical acclaim does not tend to inform popular success. Both highly-controversial **and** highly rated books tend to be the most popular.

## Conclusions

-   How has recent conglomeration of publishers changed the literary marketplace?
    -   For physical books, the publishing industry has undergone greater diversification in recent years.
    -   For e-books and audiobooks, large conglomerate publishers have grown to control the digital publishing industry.
