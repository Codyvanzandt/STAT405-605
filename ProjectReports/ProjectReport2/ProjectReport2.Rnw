...
# 2018
book2018 <- checkouts_2018_2022[(checkouts_2018_2022$CheckoutYear == 2018) & (checkouts_2018_2022$MaterialType == "BOOK") , ]
# 2018 textbook
...
# 2019
book2019 <- checkouts_2018_2022[(checkouts_2018_2022$CheckoutYear == 2019) & (checkouts_2018_2022$MaterialType == "BOOK") , ]
# 2019 textbook
...
# 2020
book2020 <- checkouts_2018_2022[(checkouts_2018_2022$CheckoutYear == 2020) & (checkouts_2018_2022$MaterialType == "BOOK") , ]
# 2020 textbook
...
# 2021
book2021 <- checkouts_2018_2022[(checkouts_2018_2022$CheckoutYear == 2021) & (checkouts_2018_2022$MaterialType == "BOOK") , ]
# 2021 textbook
...
# 2022
book2022 <- checkouts_2018_2022[(checkouts_2018_2022$CheckoutYear == 2022) & (checkouts_2018_2022$MaterialType == "BOOK") , ]
# 2022 textbook
...
SF_data <- data.frame(txt = c(txtbook2018, txtbook2019, txtbook2020, txtbook2021, txtbook2022), 
                      ...
                      Year = c( rep(2018, times = length(txtbook2018)), 
                                rep(2019, times = length(txtbook2019)),
                                rep(2020, times = length(txtbook2020)),
                                rep(2021, times = length(txtbook2021)),
                                rep(2022, times = length(txtbook2022))
                                ))
...
ggplot(data = SF_data) + 
  ...
  geom_point() + 
  scale_shape_binned(n.breaks = 6, breaks = c(2018, 2019, 2020, 2021, 2022)) + 
  labs(x = "Logarithm of Normalized Increase in Textbook Checkouts", 
       y = "Logarithm of Normalized Increase in All Book Checkouts", 
       title = "Logarithmic Scatter Plot of the Normalized Increase in Textbook vs All Book Checkouts",
