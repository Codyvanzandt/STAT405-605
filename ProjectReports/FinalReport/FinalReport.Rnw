...
\begin{figure}[H]
\begin{center}
<<publisherconglomeration,echo=FALSE,fig.width=8,fig.height=5>>=
query <- paste0("
...
\begin{figure}[H]
\begin{center}
<<killer1, echo=FALSE,message=FALSE,results='hide',fig.width=7,fig.height=5>>=
...
\begin{figure}[H]
\begin{center}
<<killer2, echo=FALSE,message=FALSE,results='hide',fig.width=7,fig.height=5>>=
...
\subsubsection*{Do popular books explode onto the scene or accumulate readers more gradually?}

\subsubsection*{How do the popular success and critical acclaim of novels differ?}

\subsubsection*{How has recent conglomeration of publishers changed the literary marketplace?}
